...
$wwd = $nodeID->field_what_we_do['und'][0]['value'];
$wwd_intro = $nodeID->field_what_we_do_intro['und'][0]['value'];
$wwww_intro = $nodeID->field_wwww_intro['und'][0]['value'];
        ...
        <div class="grid__row">
            ...
            <div class="grid__wrapper grid__wrapper--5 grid__wrapper--overlined">
                ...
                <?php
                    ...
                    $partners = field_get_items('node', $nodeID, 'field_partner');

                    foreach ($partners as $partner):

                        $fc = field_collection_field_get_entity($partner);

                        $logo = base_path() . 'sites/default/files/' . $fc->field_logo['und']['0']['filename'];
                        $name = $fc->field_partner_name['und']['0']['value'];
