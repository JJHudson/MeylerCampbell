    ...
    <section class="section section--intro fade fade--up">
        ...
        <div class="grid__row">
            ...
            <div class="grid__wrapper grid__wrapper--2 grid__wrapper--overlined">
                ...
                <p>For a full list of our partners, <a class="color--gold" href="<?= base_path() . 'sites/default/files/' . $nodeID->field_full_partner_list['und'][0]['filename']; ?>" target="_blank">click here.</a>
            ...
            <div class="grid__wrapper grid__wrapper--5 grid__wrapper--overlined">
                ...
                <?php
                    ...
                    foreach ($partners as $partner) {
                        ...
                        $tid = $fc->field_logo_type['und']['0']['tid'];
                        $term = taxonomy_term_load($tid);
                        $type = $term->name;

                        $partnerArray[$type][] = array(
                            'logo' => $logo
                        );

                    }

                    foreach ($partnerArray as $key => $partner):
                        ...
                        <div class="grid__row grid__row--partners grid__row--underlined">
                            ...
                            <?php foreach ($partner as $partnerKey => $partnerLogo): ?>
                                    ...
                                    <div class="grid__col grid__col--1">
                                        ...
                                        <img src="<?= $partnerLogo['logo']; ?>" width="100%" alt="Our Partner" /><br /><br />
