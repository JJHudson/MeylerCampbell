    ...
    <section class="section section--intro fade fade--up">
        ...
        <div class="grid__row">
            ...
            <div class="grid__wrapper grid__wrapper--2 grid__wrapper--overlined">
                ...
                <p>For a full list of our partners, <a class="color--gold" href="<?= base_path() . 'sites/default/files/' . $nodeID->field_full_partner_list['und'][0]['value']; ?>">click here.</a>
            ...
            <div class="grid__wrapper grid__wrapper--5 grid__wrapper--overlined">
                ...
                <?php
                    ...
                    foreach ($partners as $partner):
                        ...
                        $link = $fc->field_link['und']['0']['value'];
                ...
                ?>
                        ...
                        <div class="grid__col grid__col--1">
                            ...
                            <a href="<?= $link; ?>" target="_blank">
                                ...
                                <img src="<?= $logo; ?>" alt="Who We Work With" width="100%" />
                                <br /><br />
                        ...
                        <div class="grid__col grid__col--1 grid__col--empty">&nbsp;</div>
