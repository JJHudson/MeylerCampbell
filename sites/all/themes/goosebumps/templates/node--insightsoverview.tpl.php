...
<div class="container">
			    	...
			    	<div class="grid__row grid__row--person grid__row--underlined">
			    		...
			    		<div class="grid__col grid__col--2">
			    			...
			    			<?php if($type === '7'): ?>
			    				...
			    				<a href="<?= $research; ?>" class="color--black hover--gold thought">
    ...
    <section class="section fade fade--up">
		...
		<div class="grid__row">
		    ...
		    <div class="grid__wrapper grid__wrapper--5 grid__wrapper--overlined">
    			...
    			<?php
                    ...
                    $books = field_get_items('node', $nodeID, 'field_recent_publlications');

                    foreach ($books as $book):

                        $fc = field_collection_field_get_entity($book);

                    	$author = $fc->field_author['und']['0']['value'];
                    	$description = $fc->field_book_description['und']['0']['value'];
                        $link = $fc->field_link_to_buy['und']['0']['value'];
                        $monthNum = $fc->field_publish_month['und']['0']['value'];
                        $dateObj = DateTime::createFromFormat('!m', $monthNum);
                        $publishMonth = $dateObj->format('F');
                        $publishYear = $fc->field_publish_year['und']['0']['value'];
                        $title = $fc->field_book_title['und']['0']['value'];
                	...
                	<div class="grid__row grid__row--person grid__row--underlined">
			    		...
			    		<div class="grid__col grid__col--2">
			    			...
			    			<a href="<?= $link; ?>" class="color--black hover--gold thought" target="_blank">
			    				...
			    				<div class="title title--xsmall thought__title">“Lorem Ipsum”</div>
			    		...
			    		<div class="grid__col grid__col--1">
			    			...
			    			<p class="font-12">
			    				<?= $author; ?>
			    				<em><?= $publishMonth . ' ' . $publishYear ?></em>
							</p>
