		...
		<div class="grid__row grid__row--margin-bottom">
		    ...
		    <div class="grid__wrapper grid__wrapper--2 grid__wrapper--overlined">
		        ...
		        <p class="no-tablet">
		            ...
		            <br />
		            <a href="<?= base_path(); ?>connected" class="underlined">< Back to Connected</a>
		        </p>
		    	...
		    	<?php
		    		...
		    		if( count($body) > 0) {
		    			...
		    			print '<div class="grid__col grid__col--3">';
		    				...
		    				print '<h4 class="title title--xsmall title--light">' . $nodeID->field_intro['und'][0]['value'] . '</h4>';
