    	...
    	<div class="grid__row grid__row--margin-bottom">
    		...
    		<div class="grid__wrapper grid__wrapper--5 grid__wrapper--overlined grid__wrapper--overlined-<?= $type; ?>">
                ...
                <?php
                    ...
                    $image = base_path() . 'sites/default/files/' . $filename;

                    if( !empty($filename) ) {

                        print '<img src="'.$image.'" width="100%" alt="'.$nodeID->title.'">';
                ...
                <div class="grid__col grid__col--2">
                    ...
                    <ul class="structure">
                        ...
                        <?php
                            ...
                            foreach($nodeID->field_points['und'] as $key => $point) {

                                $value = $point['value']; 

                                print '<li class="structure__item color--'.$type.'"><span>'.$value.'</span></li>';
