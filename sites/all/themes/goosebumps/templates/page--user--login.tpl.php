        ...
        <div class="grid__row"> 
            ...
            <div class="grid__wrapper grid__wrapper--5 fade fade--up">
                ...
                <div class="grid__col grid__col--2">
                    ...
                    <p>If you have forgotten your password <a href="<?= base_path(); ?>user/password" class="color--gold">click here</a></p>

                    <p>To register an account <a href="<?= base_path(); ?>user/register" class="color--gold">click here</a></p>
