    ...
    <section class="section section--people fade fade--up">
		...
		?>
			...
			<?php
				...
				foreach ($role as $key => $person):

					print '<div class="grid__row grid__row--person">';

					// if($key % 2 !== 0) {
		   //          	print '<div class="grid__col grid__col--1">&nbsp;</div>';
		   //          }
        	...
        	?>
		            ...
		            <div class="grid__col grid__col--2">
		            	...
		            	<a href="<?= $person['link']; ?>" class="color--black hover--gold"><img src="<?= $person['image']; ?>" width="100%" alt="<?= $person['name']; ?>" class="person__image" /></a>

		            </div>

		            <div class="grid__col grid__col--3">

		                <a href="<?= $person['link']; ?>" class="title title--xsmall title--no-padding">
		                	<?= $person['name']; ?>
		                </a>

		                <p><strong><?= strip_tags($person['job']); ?></strong></p>

		                <p><?= strip_tags($person['bio']); ?></p>

		                <a href="<?= $person['link']; ?>" class="underlined">Read more</a>
